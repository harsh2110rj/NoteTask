...
/**
 * Note:  Basic Database Class for the app
 * The only class that should use this class is {@link com.example.notetask.AppProvider}
 *  ...That's why it has been made Package Private;
 *
 */
...
public static final String DATABASE_NAME="NoteTask.db";
    ...
    private AppDatabase(Context context)
{
     ...
     * @return a SQLiteDatabase helper object
     */
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        switch(oldVersion) {
            case 1:
                ...
                addTimingsTable(db);
              //  fall through to upgrade logic of version 2;
            case 2:
                addDurationsView(db);
                break;
            default:
