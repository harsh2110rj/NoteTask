...
import static com.example.notetask.AppProvider.CONTENT_AUTHORITY;
import static com.example.notetask.AppProvider.CONTENT_AUTHORITY_URI;

public class TimingsContract {
    static final String TABLE_NAME="Timing";
    //Timings Field.....
    // static class is packaged under the same class
    // in which it is declared...
    // So no instants of the class can be created...;
